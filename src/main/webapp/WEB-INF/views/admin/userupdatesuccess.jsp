	...
	<div class="row-fluid" style="height: 400px;">
		...
		<div class="span9 dashboard-rightpanel margin30-b" id="rightpanel"
			...
			<div class="alert alert-info" style="text-align:center;color:green;">
				<c:if test="${status=='success'}"><span>User information has been successfully update for username: ${user.userName}</span></c:if>
				<c:if test="${status!='success'}"><span>User information could not be updated at this time. Please try again.</span></c:if>
			</div>
